  ...
  <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Home</a>
                <a href="/about" class="text-gray-300 rounded-md px-3 py-2 text-sm font-medium " aria-current="page">About</a>
                <a href="/contact" class="text-gray-300 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Contact</a>
                </div>
            </div>
            </div>
            <div class="hidden md:block">
    ...
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <p>Welcome to the PHP for Beginners home page.</p>
      </div>
    </main>
  </div>
